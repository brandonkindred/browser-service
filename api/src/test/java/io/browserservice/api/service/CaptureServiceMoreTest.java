...
class CaptureServiceMoreTest {
    ...
    void captureIoFromScreenshotMapsToUpstreamUnavailable() throws Exception {
        ...
        assertThatThrownBy(() -> service.capture(new CaptureRequest("u",
                BrowserType.CHROME, null, null, PngEncoding.BASE64, null, null)))
    ...
    void captureWithEmptyXpathSkipsElementLookup() throws Exception {
        ...
        var resp = service.capture(new CaptureRequest("u",
                BrowserType.CHROME, null, null, PngEncoding.BASE64, "", null));
