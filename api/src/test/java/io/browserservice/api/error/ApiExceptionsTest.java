...
class ApiExceptionsTest {
    ...
    void mobileVsDesktopRequiredMapToConflict() {
        ...
        assertThat(new DesktopSessionRequiredException().getCode()).isEqualTo("desktop_session_required");
        assertThat(new DesktopSessionRequiredException().getHttpStatus()).isEqualTo(HttpStatus.CONFLICT);
    }
    ...
    void validationFailedHasDetailsOverload() {
        ...
        ValidationFailedException withDetails = new ValidationFailedException("bad",
                java.util.Map.of("field", "x"));
