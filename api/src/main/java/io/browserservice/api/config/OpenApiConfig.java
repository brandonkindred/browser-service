    ...
    public OpenAPI browserServiceOpenApi() {
        return new OpenAPI()
                .info(new Info()
                        ...
                        .description("Standalone service that exposes Selenium/Appium browser sessions over HTTP.")
                        .license(new License().name("MIT").url("https://opensource.org/licenses/MIT")))
                .servers(List.of(
                        new Server().url("http://browser-service.internal/v1").description("Internal VPC endpoint"),
                ...
                .tags(List.of(
                        ...
                        new Tag().name("Screenshots").description("Viewport, full-page, and element screenshots"),
