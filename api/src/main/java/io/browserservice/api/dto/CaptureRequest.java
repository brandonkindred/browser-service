...
public record CaptureRequest(
    ...
    @Schema(
            description = "Response encoding (BINARY emits an href, BASE64 inlines the bytes).",
            nullable = true)
        PngEncoding encoding,
    @Schema(description = "Optional XPath to locate and describe a single element", nullable = true)
        String xpath,
    @Schema(description = "Include the page HTML source in the response", nullable = true)
