...
/**
 * Polls {@code [location.href, document.readyState]} on a slow cadence and pushes {@code
 * event{kind:"navigation.changed"}} when either value changes. Suppresses duplicate consecutive
 * ticks. {@link UnhandledAlertException} is swallowed — the alert watcher will surface it.
 */
public final class NavigationWatcher implements SessionEventWatcher {
  ...
  @Override
  public void tick() {
    locks.tryDoWithLock(handle, lockTimeoutMs, this::probe).ifPresent(this::emitOnChange);
  }
