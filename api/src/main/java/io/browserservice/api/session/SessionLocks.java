...
public class SessionLocks {
  ...
  /**
   * Acquires the session lock with a custom short timeout for server-driven background observers
   * (the WS event watchers). Returns {@link Optional#empty()} on contention or interrupt — callers
