...
public class BrowserFactoryTest {
  ...
  public void testCreateDriverUnsupportedTypeMessage() throws MalformedURLException {
    ...
    WebDriverException ex =
        assertThrows(
            WebDriverException.class, () -> BrowserFactory.createDriver("unsupported", url));
  ...
  public void testCreateBrowserStackBrowserUnsupportedType() throws MalformedURLException {
    ...
    assertThrows(
        Exception.class, () -> BrowserFactory.createBrowserStackBrowser("chrome", url, props));
  }
  ...
  public void testCreateBrowserStackBrowserFirefox() throws MalformedURLException {
    ...
    assertThrows(
        Exception.class, () -> BrowserFactory.createBrowserStackBrowser("firefox", url, props));
  }
}
