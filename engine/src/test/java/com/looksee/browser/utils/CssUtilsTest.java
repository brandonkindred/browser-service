...
public class CssUtilsTest {
  ...
  @Mock private MockJsDriver driver;
  ...
  public void testLoadPreRenderCssProperties() throws Exception {
    org.jsoup.nodes.Document jsoupDoc =
        org.jsoup.Jsoup.parse("<html><body><p>Hello</p></body></html>");
    ...
    Map<String, String> result =
        CssUtils.loadPreRenderCssProperties(jsoupDoc, w3cDoc, ruleSetList, url, "//p", elem);
    assertNotNull(result);
    assertEquals("red", result.get("color"));
  }
