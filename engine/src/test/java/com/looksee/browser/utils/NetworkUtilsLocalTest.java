...
/**
 * Coverage-focused tests for NetworkUtils that exercise the URL/stream paths
 * against a local loopback HTTP server. The real method only accepts HTTPS, so
 * we verify the negative paths (cast failures, invalid hosts).
 */
