...
public class HtmlUtilsTest {
  ...
  public void testCleanSrcRemovesLinks() {
    String src =
        "<html><head><link rel='stylesheet' href='style.css'></head><body>Page</body></html>";
    String result = HtmlUtils.cleanSrc(src);
  ...
  public void testExtractStylesheetsMalformedUrl() {
    String src =
        "<html><head><link rel='stylesheet' href='not-a-valid-url'></head><body></body></html>";
    List<String> result = HtmlUtils.extractStylesheets(src);
    assertNotNull(result);
  ...
  public void testExtractStylesheetsProtocolRelativeUrl() {
    String src =
        "<html><head><link rel='stylesheet' href='//cdn.example.com/style.css'></head><body></body></html>";
    List<String> result = HtmlUtils.extractStylesheets(src);
