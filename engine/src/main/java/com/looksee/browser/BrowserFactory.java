...
/**
 * Factory for creating WebDriver instances and Browser objects. Encapsulates browser-specific
 * configuration and driver creation logic.
 */
public final class BrowserFactory {
   ...
   *     <p>precondition: browserType != null precondition: hubUrl != null
   */
   ...
   *     <p>precondition: hub_node_url != null
   */
   ...
   * @return the created Browser
   * @throws MalformedURLException if the URL is malformed
   *     <p>precondition: browserType != null precondition: hubUrl != null precondition: properties
   *     != null
   */
  public static Browser createBrowserStackBrowser(
      String browserType, URL hubUrl, BrowserStackProperties properties)
  ...
  /**
   * Creates a RemoteWebDriver configured for BrowserStack. Credentials are passed via capabilities
   * rather than embedded in the URL. Headless mode is omitted since BrowserStack manages the
   * display environment.
   */
