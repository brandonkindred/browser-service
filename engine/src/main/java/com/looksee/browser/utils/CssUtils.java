...
public final class CssUtils {
   ...
   *     <p>precondition: element != null precondition: driver != null
   */
   ...
   *     <p>precondition: rule_sets != null precondition: element != null
   */
  public static Map<String, String> loadCssPrerenderedPropertiesUsingParser(
      List<RuleSet> rule_sets, org.jsoup.nodes.Node element) {
    ...
    for (RuleSet rule_set : rule_sets) {
      for (CombinedSelector selector : rule_set.getSelectors()) {
        ...
        if (element.attr("class").contains(selector_str)
            || element.attr("id").contains(selector_str)
            || element.nodeName().equals(selector_str)) {
   ...
   *     <p>precondition: jsoup_doc != null precondition: w3c_document != null precondition:
   *     rule_set_list != null precondition: url != null precondition: xpath != null precondition:
   *     element != null
   */
  public static Map<String, String> loadPreRenderCssProperties(
      Document jsoup_doc,
   ...
   *     <p>precondition: w3c_document != null precondition: map != null precondition: url != null
   *     precondition: xpath != null
   */
  public static Map<String, String> loadCssPropertiesUsingParser(
      Document w3c_document, StyleMap map, URL url, String xpath) throws XPathExpressionException {
    assert w3c_document != null;
    assert map != null;
    assert url != null;
    assert xpath != null;
    ...
    if (style != null) {
      for (String property : style.getPropertyNames()) {
        ...
        if (property_value == null
            || property_value.isEmpty()
            || "none".equalsIgnoreCase(property_value)) {
          continue;
        }
