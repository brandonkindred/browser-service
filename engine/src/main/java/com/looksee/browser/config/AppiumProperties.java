 ...
 * Spring {@code @Bean} method with {@code @ConfigurationProperties(prefix = "appium")}. Non-Spring
...
public class AppiumProperties {
  ...
  /**
   * Browser name for mobile web testing (e.g., "Chrome" for Android, "Safari" for iOS). Leave
   * null/empty for native app testing when {@code app} is set.
   */
  ...
  /**
   * Path or URL to the application (.apk/.ipa) for native app testing. Leave null/empty for mobile
   * web testing.
   */
  private String app;

  /**
   * Connection timeout for Appium connections in milliseconds. Default is 60000 (60 seconds) since
   * mobile sessions take longer to start.
   */
  private int connectionTimeout = 60000;

  /** Maximum number of retry attempts for Appium connections. Default is 3. */
