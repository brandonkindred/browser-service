...
/**
 * Constructs and executes touch actions for Appium mobile drivers. This is the mobile counterpart
 * of {@link ActionFactory}.
 */
public class MobileActionFactory {
  ...
  public MobileActionFactory(WebDriver driver) {
    ...
    if (!(driver instanceof PerformsTouchActions)) {
      throw new IllegalArgumentException(
          "Driver must implement PerformsTouchActions for mobile actions");
    }
   ...
   *     <p>precondition: elem != null precondition: input != null precondition: action != null
   */
  @SuppressWarnings("rawtypes")
  public void execAction(WebElement elem, String input, MobileAction action)
    ...
    switch (action) {
      case TAP:
        new TouchAction(driver).tap(ElementOption.element(elem)).perform();
        break;
      ...
      case LONG_PRESS:
        new TouchAction(driver).longPress(ElementOption.element(elem)).release().perform();
        break;
