...
/**
 * Manages a Selenium browser session and provides methods for interacting with the browser. Handles
 * navigation, scrolling, screenshots, element interaction, and DOM manipulation.
 *
